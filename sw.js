const CACHE_NAME = 'fd-v1.8.166';
const WORKER_API_HOSTNAME = 'floorplan-dashboard-api.mko-floorplan-dashboard.workers.dev';

const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.8.166',
  'app.css?v=1.8.166',
  'data-service.js?v=1.8.166',
  'diagnostics-service.js?v=1.8.166',
  'floorplan-cache-service.js?v=1.8.166',
  'floorplan-view-service.js?v=1.8.166',
  'auth-service.js?v=1.8.166',
  'status-service.js?v=1.8.166',
  'status-sync-service.js?v=1.8.166',
  'mode-service.js?v=1.8.166',
  'image-editor-service.js?v=1.8.166',
  'viewport-service.js?v=1.8.166',
  'marker-service.js?v=1.8.166',
  'door-action-service.js?v=1.8.166',
  'ui-shell-service.js?v=1.8.166',
  'edit-ui-service.js?v=1.8.166',
  'pdf-import-service.js?v=1.8.166',
  'upload-service.js?v=1.8.166',
  'select-sheet-service.js?v=1.8.166',
  'side-panel-service.js?v=1.8.166',
  'app.js?v=1.8.166',
  'version.json',
  'manifest.json',
  'icon-192.png',
