...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.37',
  'app.css?v=1.9.37',
  'env-config.js?v=1.9.37',
  'data-service.js?v=1.9.37',
  'diagnostics-service.js?v=1.9.37',
  'floorplan-cache-service.js?v=1.9.37',
  'floorplan-view-service.js?v=1.9.37',
  'auth-service.js?v=1.9.37',
  'status-service.js?v=1.9.37',
  'status-sync-service.js?v=1.9.37',
  'mode-service.js?v=1.9.37',
  'image-editor-service.js?v=1.9.37',
  'viewport-service.js?v=1.9.37',
  'marker-service.js?v=1.9.37',
  'door-action-service.js?v=1.9.37',
  'ui-shell-service.js?v=1.9.37',
  'export-service.js?v=1.9.37',
  'edit-ui-service.js?v=1.9.37',
  'pdf-import-service.js?v=1.9.37',
  'upload-service.js?v=1.9.37',
  'select-sheet-service.js?v=1.9.37',
  'side-panel-service.js?v=1.9.37',
  'app.js?v=1.9.37',
  'version.json',
  'manifest.json',
  'icon-192.png',
