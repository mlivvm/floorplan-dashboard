...
const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.9.7',
  'app.css?v=1.9.7',
  'env-config.js?v=1.9.7',
  'data-service.js?v=1.9.7',
  'diagnostics-service.js?v=1.9.7',
  'floorplan-cache-service.js?v=1.9.7',
  'floorplan-view-service.js?v=1.9.7',
  'auth-service.js?v=1.9.7',
  'status-service.js?v=1.9.7',
  'status-sync-service.js?v=1.9.7',
  'mode-service.js?v=1.9.7',
  'image-editor-service.js?v=1.9.7',
  'viewport-service.js?v=1.9.7',
  'marker-service.js?v=1.9.7',
  'door-action-service.js?v=1.9.7',
  'ui-shell-service.js?v=1.9.7',
  'edit-ui-service.js?v=1.9.7',
  'pdf-import-service.js?v=1.9.7',
  'upload-service.js?v=1.9.7',
  'select-sheet-service.js?v=1.9.7',
  'side-panel-service.js?v=1.9.7',
  'app.js?v=1.9.7',
  'version.json',
  'manifest.json',
  'icon-192.png',
