const CACHE_NAME = 'fd-v1.8.164';
const WORKER_API_HOSTNAME = 'floorplan-dashboard-api.mko-floorplan-dashboard.workers.dev';

const STATIC_ASSETS = [
  './',
  'index.html',
  'admin-dashboard-tokens.css?v=1.8.164',
  'app.css?v=1.8.164',
  'data-service.js?v=1.8.164',
  'diagnostics-service.js?v=1.8.164',
  'floorplan-cache-service.js?v=1.8.164',
  'floorplan-view-service.js?v=1.8.164',
  'auth-service.js?v=1.8.164',
  'status-service.js?v=1.8.164',
  'status-sync-service.js?v=1.8.164',
  'mode-service.js?v=1.8.164',
  'image-editor-service.js?v=1.8.164',
  'viewport-service.js?v=1.8.164',
  'marker-service.js?v=1.8.164',
  'door-action-service.js?v=1.8.164',
  'ui-shell-service.js?v=1.8.164',
  'edit-ui-service.js?v=1.8.164',
  'pdf-import-service.js?v=1.8.164',
  'upload-service.js?v=1.8.164',
  'select-sheet-service.js?v=1.8.164',
  'side-panel-service.js?v=1.8.164',
  'app.js?v=1.8.164',
  'version.json',
  'manifest.json',
  'icon-192.png',
